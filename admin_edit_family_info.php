...
//Database Connection
    ...
    if(isset($_GET['edit_id'])){
        $sql = "SELECT * FROM family_info WHERE id='$edit_id'AND family_member_no='$index'";
    ...
    if(isset($_POST['btn-update'])){
        ...
        $update = "UPDATE family_info SET name='$name', gender='$gender', dob='$dob', relation='$relation', dependant='$dependant'  WHERE id='$edit_id'AND family_member_no='$index'";
