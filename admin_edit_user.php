...
?>
    ...
    <html>
        ...
        <body>
            ...
            <div id="Personal Info" class="tabcontent">
                ...
                <div class='imageUpload'>
                    <?php
                        $sql = "SELECT image_location FROM users WHERE id=".$_GET['edit_id'];
                ...
                <div class='imageUpload'>
                    <form method="POST" action="admin_upload.php?edit_id=<?php echo $_GET['edit_id']?>" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                ?><tr><th>Actions</th><td><a href="admin_edit_personal_info.php?edit_id=<?php echo $row['id']; ?>" alt="edit" >Edit</a></td><tr><?php
                            }
                        } else {
                            echo "0 results";
                        }
            ...
            <div id="Family Info" class="tabcontent">
                ...
                <table id="t01">
                    <?php
                        ...
                        $sql = "SELECT * FROM family_info WHERE id=".$_GET['edit_id'];
                        $result = mysqli_query($db, $sql);
     ...
     ///////////                           ?><td><a href="admin_edit_family_info.php?edit_id=<?php echo $row['id']; ?>&index=<?php echo $row['family_member_no']; ?>" alt="edit" >Edit</a></td><tr><?php
                                $i++;
                            }
                        } else {
                            echo "0 results";
            ...
            <div id="Prev Employment" class="tabcontent">
                ...
                <table id="t01">
                    <?php
                        ...
                        $sql = "SELECT * FROM prev_emp WHERE id=".$_GET['edit_id'];
                        $result = mysqli_query($db, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                ?><td><a href="admin_edit_prev_employment.php?edit_id=<?php echo $row['id']; ?>&index=<?php echo $row['pe_no']; ?>" alt="edit" >Edit</a></td><tr><?php
            ...
            <div id="Qualification" class="tabcontent">
                ...
                <table id="t01">
                    <?php
                        ...
                        $sql = "SELECT * FROM aca_qualification WHERE id=".$_GET['edit_id'];
                        $result = mysqli_query($db, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                ?><td><a href="admin_edit_aca_qualification.php?edit_id=<?php echo $row['id']; ?>&index=<?php echo $row['aq_no']; ?>" alt="edit" >Edit</a></td><tr><?php
                ...
                <table id="t01">
                    <?php
                        ...
                        $sql = "SELECT * FROM prof_qualification WHERE id=".$_GET['edit_id'];
                        $result = mysqli_query($db, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                ?><td><a href="admin_edit_prof_qualification.php?edit_id=<?php echo $row['id']; ?>&index=<?php echo $row['pq_no']; ?>" alt="edit" >Edit</a></td><tr><?php
            ...
            <div id="Training History" class="tabcontent">
                ...
                <table id="t01">
                    <?php
                        ...
                        $sql = "SELECT * FROM training_history WHERE id=".$_GET['edit_id'];
                        $result = mysqli_query($db, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                ?><td><a href="admin_edit_training_history.php?edit_id=<?php echo $row['id']; ?>&index=<?php echo $row['t_no']; ?>" alt="edit" >Edit</a></td><tr><?php
            ...
            <div id="Posting History" class="tabcontent">
                ...
                <table id="t01">
                    <?php
                        ...
                        $sql = "SELECT * FROM posting_history WHERE id=".$_GET['edit_id'];
                        $result = mysqli_query($db, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                ?><td><a href="admin_edit_posting_history.php?edit_id=<?php echo $row['id']; ?>&index=<?php echo $row['poh_no']; ?>" alt="edit" >Edit</a></td><tr><?php
            ...
            <div id="Promotion History" class="tabcontent">
                <table id="t01">
                    <?php
                        ...
                        $sql = "SELECT * FROM promotion_history WHERE id=".$_GET['edit_id'];
                        $result = mysqli_query($db, $sql);
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                ?><td><a href="admin_edit_promotion_history.php?edit_id=<?php echo $row['id']; ?>&index=<?php echo $row['p_no']; ?>" alt="edit" >Edit</a></td><tr><?php
            ...
            <div>
                <a href="admin_user_view.php" alt="Go back" >SEE ALL USERS</a>
            </div>
